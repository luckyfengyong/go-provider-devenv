...
import (
	...
	paasv1 "redis-operator/pkg/apis/paas/v1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &paasv1.RedisCluster{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
...
func newPodForCR(cr *paasv1.RedisCluster) *corev1.Pod {
